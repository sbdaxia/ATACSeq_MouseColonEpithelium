...
# Purpose
 - To examine if up/down-regulated DEGs from KRas colonic epithelium RNA-Seq preferrentially have up/down-regulated ATAC-Seq peaks
 - To examine if up/down-regulated ATAC-Seq peaks preferrentially have up/down-regulated DEGs from KRas colonic epithelium RNA-Seq
...
```{r message=FALSE, warning=FALSE}
# RNA-Seq
rna_DGE <- read_csv("../../../../RNA-Seq/Mouse colon epithelium/Analysis/Differential Analysis.csv")
